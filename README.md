...
- **Fonts**: Bricolage Grotesque, Be Vietnam Pro, IBM Plex Mono (Google Fonts)
...
- **Maintainable Styles**: CSS đã tách thành nhiều file theo vai trò (`theme`, `components`, `sections`, `responsive`).

## Tùy biến nhanh
- Xem `CUSTOMIZE.md` để chỉnh màu, font, khoảng cách và tốc độ animation tại một chỗ.
